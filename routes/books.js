...
router.get('/:id', async (req, res) => {
  try {
    const book = await Book.findById(req.params.id)
                           .populate('author')      //to convert author id to author info with all the author's info
                           .exec()
...
router.put('/:id', async (req, res) => {
  ...
  try {
    ...
    book.publishDate = new Date(req.body.publishDate)   //because returned as string
